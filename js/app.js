const pepsi = [
    {
        ...
        protein_per:"0%",
        ml:"250ml",
        poster1:"imgs/1 Pespi white.png",
        poster2:"imgs/1 Pespi blue.png",
        main_poster:"imgs/pepsi diet.png"
    },
    
    {
        ...
        protein_per:"0%",
        ml:"330ml",
        poster1:"imgs/2 can white.png",
        poster2:"imgs/2 can blue.png",
        main_poster:"imgs/can.png"
    },

    {
        ...
        protein_per:"0%",
        ml:"500ml",
        poster1:"imgs/3 Pepsi white.png",
        poster2:"imgs/3 Pepsi blue.png",
        main_poster:"imgs/pepsi .5ltr.png"
    },

    {
        ...
        protein_per:"0%",
        ml:"1 LTR",
        poster1:"imgs/4 Pepsi white.png",
        poster2:"imgs/4 Pepsi blue.png",
        main_poster:"imgs/pepsi 1ltr.png"
    },

    {
        ...
        protein_per:"0%",
        ml:"1.5 LTR",
        poster1:"imgs/5 Pepsi white.png",
        poster2:"imgs/5 Pepsi blue.png",
        main_poster:"imgs/pepsi 1.5ltr.png"
    },

    {
        ...
        protein_per:"0%",
        ml:"2 LTR",
        poster1:"imgs/6 Pepsi white.png",
        poster2:"imgs/6 Pepsi blue.png",
        main_poster:"imgs/pepsi 2ltr.png"
    },
]
...
Array.from(document.getElementsByClassName('card_pepsi')).forEach((ele, i)=> {
    ele.addEventListener('click', ()=> {
        ...
        document.getElementById('crbohydrate').innerText = pepsi[i].carbohydrate;
        document.getElementById('crbohydrate1').innerText = pepsi[i].carbohydrate_per;
...
document.getElementById('left_btn').addEventListener('click', () =>{
    ...
    if(index < 0){
        ...
        document.getElementById('crbohydrate').innerText = pepsi[index].carbohydrate;
        document.getElementById('crbohydrate1').innerText = pepsi[index].carbohydrate_per;
